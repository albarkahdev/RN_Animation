...
import {
  Section, SMALL_HEADER_HEIGHT, MEDIUM_HEADER_HEIGHT, PADDING, CURSOR_WIDTH,
} from './Model';
...
const {
  Extrapolate, interpolate, add, multiply, divide, greaterThan, cond,
} = Animated;
...
export default class Headers extends React.PureComponent<HeadersProps> {
  ...
  getStyle = (headerHeight: Animated.Value<number>, index: number) => {
